...
\ifimp
    ...
    \input{Chapters/Chapter6} % Conclusions and Term 2 work
    \input{Chapters/Chapter7} % Conclusions and Term 2 work
\else
    \input{Chapters/Chapter5_Rsh} % Conclusions and Term 2 work
\fi
%% ----------------------------------------------------------------
\label{Bibliography}
